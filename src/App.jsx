...
const App = () => {
  ...
  const getBackgroundImage = () => {
    ...
    return 'https://images.unsplash.com/photo-1592210454359-9043f067919b';
  };
      ...
      <div className="bg-white/10 backdrop-blur-lg p-8 rounded-2xl shadow-2xl w-full max-w-md border border-white/20 transition-transform transform hover:scale-105">
        ...
        <div className="mb-4">
          <input
            ...
            className="w-full font-mono py-3 outline-0 text-xl px-4 bg-white/10 placeholder-black border border-white/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 transition text-black "
          />
        </div>
        <button
          onClick={checkWeather}
          className="w-full py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all duration-300 outline-none"
        >
          Search Weather
        </button>
        {weather.cityname && (
          <div className="mt-6 font-mono space-y-2 text-black capitalize">
